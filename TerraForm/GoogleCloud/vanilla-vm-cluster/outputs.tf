...
output "master_node_public_ip" {
  value = "${module.vms.master_node_public_ip}"
}

output "master_node_private_ip" {
  value = "${module.vms.master_node_private_ip}"
}

output "worker_node1_public_ip" {
  value = "${module.vms.worker_node1_public_ip}"
}
...
output "worker_node2_private_ip" {
  value = "${module.vms.worker_node2_private_ip}"
}